    ...
    class ModuleLoader
    {
        ...
        private static function registerFunctions($moduleName, $modulePrefix)
        {
            ...
            foreach ($class->GetMethods() as $method) {
                ...
                if (in_array($method->GetName(), ['__construct', '__destruct', '__call', '__callStatic', '__get', '__set', '__isset', '__sleep', '__wakeup', '__toString', '__invoke', '__set_state', '__clone', '__debuginfo', 'Create', 'Destroy', 'ApplyChanges', 'ReceiveData', 'ForwardData', 'RequestAction', 'MessageSink', 'GetConfigurationForParent', 'Translate'])) {
                    continue;
                }
