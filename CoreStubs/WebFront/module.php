...
class WebFrontVisualization extends IPSModule
{
    public function AudioNotification(string $Title, int $MediaID): void
    {
    ...
    public function SendPopup(string $Title, string $Text): void
    {
        // No need to implement this function.
    }

    public function SwitchPage(string $PageName): void
    {
        // No need to implement this function.
    }
}
